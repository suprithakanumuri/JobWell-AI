...
// Base API URL using Vite environment variable, fallback to localhost
...
export const API_PATHS = {
  ...
  AI: {
    ...
    GENERATE_EXPLANATION: `${BASE_URL}/ai/generate-explanation`,  // ✅ matches backend
    GENERATE_SHORT_ANSWER: `${BASE_URL}/ai/generate-short-answer`, // ✅ fixed 404 error
  },
