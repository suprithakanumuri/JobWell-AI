  ...
  return (
    <div role="status" className="animate-pulse space-y-4 max-w-3xl">
      ...
      <div className="bg-gray-100 dark:bg-gray-700 rounded p-4 space-y-2">
        <div className="h-2.5 bg-gray-300 rounded w-3/4 dark:bg-gray-600"></div>
        <div className="h-2.5 bg-gray-300 rounded w-2/3 dark:bg-gray-600"></div>
      </div>

      {/* Answer Loading Section */}
